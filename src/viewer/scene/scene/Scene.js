...
class Scene extends Component {
     ...
     * @param {Boolean} [params.pickSurfacePrecision=false] When picking an Entity surface position, indices whether or not we want a maximum accuracy in {@link PickResult#worldPos}. Only works when {@link Scene#pickSurfacePrecisionEnabled} is ````true````.
